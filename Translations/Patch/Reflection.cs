...
namespace CalamityCN.Translations.Patch
{
	...
	public static class Reflection
	{
		...
		public static void Load()
		{
				...
				list.Add(new ValueTuple<string, string>("死灵炼注", "将该物品转化为更加强大的物品。"));
				...
				list.Add(new ValueTuple<string, string>("憎懣", "使弹幕的伤害取决于目标与你的距离，距离越远，伤害越高。反之亦然。"));
				list.Add(new ValueTuple<string, string>("嗜血", "使弹幕的伤害取决于目标与你的距离，距离越近，伤害越高。反之亦然。"));
				...
				property2.SetValue(typeFromHandle, new Enchantment("祛魔", string.Empty, -18591774, null, delegate (Item item)
				{
				...
				DifficultyModeSystem.Difficulties[0].Name = "无";
				DifficultyModeSystem.Difficulties[0].ShortDescription = "没有开启任何灾厄难度的泰拉之旅";
				DifficultyModeSystem.Difficulties[1].Name = "复仇";
				DifficultyModeSystem.Difficulties[1].ShortDescription = "[c/F54254:预期的灾厄之旅！]";
				DifficultyModeSystem.Difficulties[2].Name = "死亡";
				DifficultyModeSystem.Difficulties[2].ShortDescription = "[c/C82DF7:对更有经验的，想复仇模式更进一步的玩家的更强挑战]";
				DifficultyModeSystem.Difficulties[3].Name = "恶意哪去了?";
				DifficultyModeSystem.Difficulties[3].ShortDescription = "[c/FB7152:恶意模式已经被移除，但它的AI改动留在了Boss Rush中]\n[c/FB7152:如果你因为之前计划进行恶意之旅而感到失望，我们诚挚地道歉]";
