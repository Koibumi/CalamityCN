...
namespace CalamityCN.Translations.Patch
{
	public class BCAddBossPatch : OnPatcher
	{
		...
		private void Translation(AddCalamityBossesDelegate orig, Mod bossChecklist, Mod calamity)
		{
			...
			list2.Add(ModContent.ItemType<LoreDesertScourge>());
			list2.Add(ModContent.ItemType<ThankYouPainting>());
			...
			list3.Add(ModContent.ItemType<LoreCrabulon>());
			list3.Add(ModContent.ItemType<ThankYouPainting>());
			...
			list4.Add(ModContent.ItemType<LoreHiveMind>());
			list4.Add(ModContent.ItemType<RottingEyeball>());
			list4.Add(ModContent.ItemType<ThankYouPainting>());
			...
			list5.Add(ModContent.ItemType<LorePerforators>());
			list5.Add(ModContent.ItemType<BloodyVein>());
			list5.Add(ModContent.ItemType<ThankYouPainting>());
			...
			list7.Add(ModContent.ItemType<LoreSlimeGod>());
			list7.Add(ModContent.ItemType<ThankYouPainting>());
			...
			list8.Add(ModContent.ItemType<LoreArchmage>());
			list8.Add(ModContent.ItemType<ThankYouPainting>());
			...
			list9.Add(ModContent.NPCType<AquaticScourgeBodyAlt>());
			...
			list10.Add(ModContent.ItemType<LoreAquaticScourge>());
			list10.Add(ModContent.ItemType<LoreSulphurSea>());
			list10.Add(ModContent.ItemType<ThankYouPainting>());
			...
			list11.Add(ModContent.ItemType<LoreAzafure>());
			list11.Add(ModContent.ItemType<LoreBrimstoneElemental>());
			list11.Add(ModContent.ItemType<CharredRelic>());
			list11.Add(ModContent.ItemType<ThankYouPainting>());
			...
			list12.Add(ModContent.ItemType<CalamitasCloneTrophy>());
			list12.Add(ModContent.ItemType<CataclysmTrophy>());
			list12.Add(ModContent.ItemType<CatastropheTrophy>());
			list12.Add(ModContent.ItemType<CalamitasCloneMask>());
			list12.Add(ModContent.ItemType<HoodOfCalamity>());
			list12.Add(ModContent.ItemType<RobesOfCalamity>());
			list12.Add(ModContent.ItemType<LoreCalamitasClone>());
			list12.Add(ModContent.ItemType<ThankYouPainting>());
			...
			list15.Add(ModContent.ItemType<LoreAbyss>());
			list15.Add(ModContent.ItemType<LoreLeviathanAnahita>());
			list15.Add(ModContent.ItemType<ThankYouPainting>());
			...
			list16.Add(ModContent.ItemType<LoreAstrumAureus>());
            list16.Add(ModContent.ItemType<ThankYouPainting>());
			...
			list17.Add(ModContent.ItemType<LorePlaguebringerGoliath>());
			list17.Add(ModContent.ItemType<PlagueCaller>());
			list17.Add(ModContent.ItemType<ThankYouPainting>());
			...
			list19.Add(ModContent.ItemType<LoreRavager>());
			list19.Add(ModContent.ItemType<ThankYouPainting>());
			...
			list22.Add(ModContent.ItemType<LoreAstrumDeus>());
			list22.Add(ModContent.ItemType<LoreAstralInfection>());
			list22.Add(ModContent.ItemType<ChromaticOrb>());
			list22.Add(ModContent.ItemType<ThankYouPainting>());
			...
			list23.Add(ModContent.ItemType<LoreProfanedGuardians>());
			list23.Add(ModContent.ItemType<ThankYouPainting>());
			...
			list24.Add(ModContent.ItemType<LoreDragonfolly>());
			list24.Add(ModContent.ItemType<ThankYouPainting>());
			...
			list25.Add(ModContent.ItemType<LoreProvidence>());
			list25.Add(ModContent.ItemType<ThankYouPainting>());
			...
			List<int> npcTypes13 = new List<int>();
			npcTypes13.Add(ModContent.NPCType<CeaselessVoid>());
			npcTypes13.Add(ModContent.NPCType<DarkEnergy>());
			...
			list26.Add(ModContent.ItemType<LoreCeaselessVoid>());
			list26.Add(ModContent.ItemType<ThankYouPainting>());
            AddBoss(bossChecklist, calamity, name19, difficulty19, npcTypes13, downed19, summon18, list26, "在地牢使用 [i:" + ModContent.ItemType<RuneofKos>().ToString() + "] 召唤", CalamityUtils.ColorMessage("时空间的裂隙从你所能触及之处隐去……", new Color(75, 0, 130)), () => true, null, null);
			...
			list28.Add(ModContent.ItemType<LoreStormWeaver>());
			list28.Add(ModContent.ItemType<LittleLight>());
			list28.Add(ModContent.ItemType<ThankYouPainting>());
			...
			list29.Add(ModContent.ItemType<LoreSignus>());
			list29.Add(ModContent.ItemType<ThankYouPainting>());
			...
			list31.Add(ModContent.ItemType<LorePolterghast>());
            list31.Add(ModContent.ItemType<ThankYouPainting>());
			...
			list32.Add(ModContent.ItemType<LoreOldDuke>());
			list32.Add(ModContent.ItemType<ThankYouPainting>());
			...
			list33.Add(ModContent.ItemType<LoreDevourerofGods>());
			list33.Add(ModContent.ItemType<ThankYouPainting>());
			...
			list34.Add(ModContent.ItemType<LoreYharon>());
            list34.Add(ModContent.ItemType<ForgottenDragonEgg>());
            list34.Add(ModContent.ItemType<McNuggets>());
            list34.Add(ModContent.ItemType<FoxDrive>());
            list34.Add(ModContent.ItemType<ThankYouPainting>());
			...
			list36.Add(ModContent.ItemType<LoreExoMechs>());
			list36.Add(ModContent.ItemType<LoreCynosure>());
			list36.Add(ModContent.ItemType<ThankYouPainting>());
            ...
            list38.Add(ModContent.ItemType<LoreCalamitas>());
            list38.Add(ModContent.ItemType<LoreCynosure>());
            list38.Add(ModContent.ItemType<BrimstoneJewel>());
			list38.Add(ModContent.ItemType<Levi>());
            list38.Add(ModContent.ItemType<ThankYouPainting>());
