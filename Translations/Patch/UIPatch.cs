...
namespace CalamityCN.Translations.Patch
{
    public class UIPatch
    {
        ...
        public static void Load()
        {
            ...
            //嘉登
            QuickTranslate(typeof(ExoMechSelectionUI), "HandleInteractionWithButton", "Thanatos, a serpentine terror with impervious armor and innumerable laser turrets.", "塔纳托斯，一条装备着厚重铠甲、搭载了无数机关炮的恐怖巨蟒。");
            QuickTranslate(typeof(ExoMechSelectionUI), "HandleInteractionWithButton", "Ares, a heavyweight, diabolical monstrosity with four Exo superweapons.", "阿瑞斯，一个搭载着四台超级星流武器的庞然巨物。");
            QuickTranslate(typeof(ExoMechSelectionUI), "HandleInteractionWithButton", "Artemis and Apollo, a pair of extremely persistent automatons with unstable energy reserves.", "阿尔忒弥斯和阿波罗，一对能量储备十分不稳定的超耐久自动机器。");
            //破译
           ...
           //难度
            ...
            QuickTranslate(typeof(SulphurousWaterMeterUI), "Draw", "Sulphuric Poisoning: ", "硫磺海水腐蚀：");
            //炼注
