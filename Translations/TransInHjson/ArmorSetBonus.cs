        ...
        public override void ModifyTooltips(Item item, List<TooltipLine> tooltips)
        {
            foreach (TooltipLine line in tooltips)
            {
                ...
                if (Main.LocalPlayer.armor[0].type == ModContent.ItemType<GemTechHeadgear>() && Main.LocalPlayer.armor[1].type == ModContent.ItemType<GemTechBodyArmor>() && Main.LocalPlayer.armor[2].type == ModContent.ItemType<GemTechSchynbaulds>())
                {
                    ...
                    line.Text = line.Text.Replace("The blue gem grants 4 extra maximum minions, increased minion damage, and negates the minion damage penalty while wielding non-summoner weapons", LangHelper.GetTextValue("CalamityMod.Items.SetBonus.GemTechEquipped.Tooltip.5", Array.Empty<object>()));
