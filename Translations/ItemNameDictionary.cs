    ...
    public class ItemNameDict
    {
        ...
        public static void Load()
        {
            ItemName = new Dictionary<string, string>()
            {
                ...
                {"MidasPrime", "迈达斯统帅" },
                //{"TheSevensStriker", "" },
                {"MarniteArchitectHeadgear", "花岗石建筑师头饰" },
                {"MarniteArchitectToga", "花岗石建筑师长袍" },
                {"MarniteDeconstructor", "花岗石重构器" },
                {"MarniteRepulsionShield", "花岗石斥力盾" },
                {"MarniteObliterator", "花岗石抹除器" },
